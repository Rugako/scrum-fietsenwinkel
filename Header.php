    ...
    <div class="container">
        <div class="container">
            <div id="logo" class="pull-left">
                <h1> <i class="fas fa-bicycle"></i><a href="HomePage_Compleet.php" class="scrollto">Haas_Bicycle</a></h1>
        ...
        <div class="search-container">
            <form action="#">
                ...
                <i><a href="Winkelmandje.php" class="fas fa-shopping-basket shop"></a ></i>
            </form>
        </div>
